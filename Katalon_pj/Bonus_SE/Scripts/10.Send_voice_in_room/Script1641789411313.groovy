...
WebUI.click(findTestObject('Object Repository/Page_Element  hehe/div__mx_AccessibleButton mx_MessageComposer_b82be4'))

WebUI.click(findTestObject('Object Repository/Page_Element  hehe/div__mx_AccessibleButton mx_VoiceRecordComp_5e8efd'))
