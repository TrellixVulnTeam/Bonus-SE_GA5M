...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Hhehe'))

WebUI.click(findTestObject('Object Repository/Page_Element  hehe/div_wwtf_mx_AccessibleButton mx_MessageActi_a531c9'))

WebUI.setText(findTestObject('Object Repository/Page_Element  hehe/div_hihi'), '<div>hihi</div>')

WebUI.click(findTestObject('Object Repository/Page_Element  hehe/div_hihi_mx_AccessibleButton mx_MessageComp_47ce31'))
