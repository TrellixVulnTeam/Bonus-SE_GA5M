...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_hello ban Tti_mx_AccessibleButton mx_Me_913ea5'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/span_'))
