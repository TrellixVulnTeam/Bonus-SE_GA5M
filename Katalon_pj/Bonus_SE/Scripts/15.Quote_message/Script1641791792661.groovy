...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_hello ban Tti_mx_AccessibleButton mx_Me_9d11e4'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/span_Quote'))

WebUI.setText(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_hello ban Ttiabc'), '<div>&gt; hello ban Tti</div><div><br></div><div>abc</div>')

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_abc_mx_AccessibleButton mx_MessageCompo_8cfd77'))
