...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/span_Share'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Share Room Message_mx_AccessibleButton _2edabc'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Share Room Message_mx_AccessibleButton _3568ae'))
