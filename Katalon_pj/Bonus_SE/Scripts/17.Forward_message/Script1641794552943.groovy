...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/span_Forward'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Send'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Forward message_mx_AccessibleButton mx__acac57'))
