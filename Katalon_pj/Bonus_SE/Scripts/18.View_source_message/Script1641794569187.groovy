...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_View source'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_View Source_mx_AccessibleButton mx_Dial_47cd05'))
