...
WebUI.click(findTestObject('Object Repository/Page_Element/span_Appearance'))

WebUI.verifyElementNotChecked(findTestObject('Page_Element 1/div_Theme_mx_Checkbox_background'), 0)

WebUI.click(findTestObject('Object Repository/Page_Element/div_Aa_mx_Slider_dot mx_Slider_dotActive'))
