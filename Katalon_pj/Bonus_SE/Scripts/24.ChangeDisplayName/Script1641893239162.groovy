...
WebUI.verifyElementPresent(findTestObject('Page_Element 1/div_ptnha19matrix.org_mx_AccessibleButton mx_UserMenu_contextMenu_themeButton'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Element/span_All settings'))

WebUI.verifyElementClickable(findTestObject('Page_Element 1/span_Labs_mx_TabbedView_maskedIcon mx_UserSettingsDialog_helpIcon'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input_Profile_mx_Field_5'), 'ptnha1')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Save'))
