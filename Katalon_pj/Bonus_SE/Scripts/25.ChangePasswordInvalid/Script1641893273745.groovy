...
WebUI.verifyElementText(findTestObject('Page_Element 1/div_Remove'), 'Remove')

WebUI.verifyElementPresent(findTestObject('Page_Element 1/div_Add'), 0)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Account_mx_Field_7'), 'cH9eeb27K7k=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Current password_mx_Field_8'), 'YYdYgnpZIxc=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_New Password_mx_Field_9'), 'YYdYgnpZIxc=')
