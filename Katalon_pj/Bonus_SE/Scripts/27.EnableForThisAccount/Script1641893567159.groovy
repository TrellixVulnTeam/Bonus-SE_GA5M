...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Username'))
...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Enable for this account_mx_AccessibleBu_6ebcf7'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Enable for this account_mx_ToggleSwitch_ball'))
