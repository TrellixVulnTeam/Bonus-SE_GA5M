...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Check for update'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Clear cache and reload_mx_Dialog_backgr_3f4278'))
