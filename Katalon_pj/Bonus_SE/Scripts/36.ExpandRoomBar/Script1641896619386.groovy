...
WebUI.verifyElementPresent(findTestObject('Page_Element/div_haha'), 0)

WebUI.click(findTestObject('Object Repository/Page_Element/span_vntuan13579_mx_RoomSublist_collapseBtn'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_vntuan13579_mx_RoomSublist_collapseBtn_f89486'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_haha'))

WebUI.click(findTestObject('Object Repository/Page_Element  haha/div_hehe'))
