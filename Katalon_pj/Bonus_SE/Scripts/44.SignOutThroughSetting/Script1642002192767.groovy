...
WebUI.click(findTestObject('Object Repository/Page_Element/span_Security  Privacy'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Sign Out'))

WebUI.click(findTestObject('Page_Element/button_I dont want my encrypted messages'))
