...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Explore rooms_mx_LanguageDropdown_input'), 'ti')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Ting Vit'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_ng nhp'))
