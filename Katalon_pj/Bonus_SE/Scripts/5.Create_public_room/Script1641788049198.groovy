...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Create a public room_mx_Field_5'), 'Room2')

WebUI.click(findTestObject('Object Repository/Page_Element/button_Create Room'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input__mx_Field_7'), 'Room2ewq')

WebUI.click(findTestObject('Object Repository/Page_Element/button_Create Room'))

WebUI.click(findTestObject('Object Repository/Page_Element  Room2/div_Room2'))
