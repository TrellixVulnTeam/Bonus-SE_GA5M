...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/input_General_mx_Field_5'))

WebUI.setText(findTestObject('Object Repository/Page_Element  Tr Cao Thin/input_General_mx_Field_5'), 'ABC')

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Save'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_GeneralSecurity  PrivacyRoles  Permissi_f2bebd'))

WebUI.setText(findTestObject('Object Repository/Page_Element  Tr Cao Thin/input_General_mx_Field_5'), '')
