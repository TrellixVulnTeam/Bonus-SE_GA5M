...
WebUI.verifyElementPresent(findTestObject('Page_Element  Administrator/span_Invite to this room'), 0)

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_ptnha19'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Share Link to User'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_httpsmatrix.toptnha19matrix.org_mx_Acce_452c44'))
