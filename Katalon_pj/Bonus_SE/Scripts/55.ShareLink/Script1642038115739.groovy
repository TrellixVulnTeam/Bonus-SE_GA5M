...
WebUI.verifyElementClickable(findTestObject('Page_Element  Tr Cao Thin/div_Share room'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Share room'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_httpsmatrix.toFfCpvSioZvOdNBsrLematrix._1ba303'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Share Room_mx_AccessibleButton mx_Dialo_364380'))
