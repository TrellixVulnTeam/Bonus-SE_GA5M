...
WebUI.verifyElementClickable(findTestObject('Page_Element  Tr Cao Thin/div_Files'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Files'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Message deleted_mx_AccessibleButton mx__334218'))

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Message deleted_mx_AccessibleButton mx__0a07ff'))
