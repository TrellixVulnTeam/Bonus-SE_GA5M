...
WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_Tr Cao Thin_mx_AccessibleButton mx_Room_93b1eb'))

WebUI.setText(findTestObject('Object Repository/Page_Element  Tr Cao Thin/input_All Rooms_focus-visible'), 'ABC')

WebUI.sendKeys(findTestObject('Object Repository/Page_Element  Tr Cao Thin/input_All Rooms_focus-visible'), Keys.chord(Keys.ENTER))
