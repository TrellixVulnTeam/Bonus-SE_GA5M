...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Sign in here'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_English (US)'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input_Catal_mx_LanguageDropdown_input'), 'Tu')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Lietuvi'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Lietuvi_1'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input_Catal_mx_LanguageDropdown_input'), 'Eng')
