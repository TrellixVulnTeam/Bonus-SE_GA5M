...
WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/div_Review_mx_AccessibleButton mx_SpacePane_f02940'))

WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/span_hey ban Khoa'))

WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/div_hey ban Khoa_mx_AccessibleButton mx_Spa_2bd6f9'))

WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/span_Settings'))

WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/div_Edit settings relating to your space_mx_31c379'))
