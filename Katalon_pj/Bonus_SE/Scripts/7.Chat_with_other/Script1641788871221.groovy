...
WebUI.setText(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_hello ban Tti'), '<div>hello ban Tti</div>')

WebUI.click(findTestObject('Object Repository/Page_Element  Tr Cao Thin/div_hello ban Tti_mx_AccessibleButton mx_Me_16cce5'))
