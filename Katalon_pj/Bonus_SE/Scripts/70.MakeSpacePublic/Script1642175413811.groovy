...
WebUI.click(findTestObject('Object Repository/Page_Element/div_hey ban Khoa_mx_AccessibleButton mx_Spa_2bd6f9'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_Settings'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_Visibility'))

WebUI.click(findTestObject('Object Repository/Page_Element/div'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Preview Space_mx_ToggleSwitch_ball'))
