...
WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/div_Invite_mx_AccessibleButton mx_SpaceRoom_87964d'))

WebUI.click(findTestObject('Object Repository/Page_Element  hey ban Khoa/span_Visibility'))
