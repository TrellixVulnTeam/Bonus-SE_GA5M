...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Continue'))

WebUI.click(findTestObject('Object Repository/Page_Element/a_Sign in here'))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Security Key_mx_Field_5'), 'PF4jXtbe/5x5+S5PgN4Kl/QbANAkWZYKqKaG9gW6gn+Po31AOnak0DX8GoEzAUkskgpeON1UhfEqZG0XXngJPA==')
