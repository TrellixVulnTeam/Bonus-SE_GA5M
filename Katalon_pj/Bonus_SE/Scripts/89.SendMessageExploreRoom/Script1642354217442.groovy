...
WebUI.click(findTestObject('Page_Element/span_Send a Direct Message'))

WebUI.click(findTestObject('Page_Element/div_Direct Messages_mx_AccessibleButton mx__57a7bb'))
